...
public class StreamsOnTasksRevokedCallbackNeededEvent extends CompletableBackgroundEvent<Void> {
    ...
    private final Set<StreamsAssignmentInterface.TaskId> activeTasksToRevoke;

    public StreamsOnTasksRevokedCallbackNeededEvent(final Set<StreamsAssignmentInterface.TaskId> activeTasksToRevoke) {
    ...
    public Set<StreamsAssignmentInterface.TaskId> activeTasksToRevoke() {
